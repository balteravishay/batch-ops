...
$json = '{"id":"task' + $node_id + '", "commandLine":"cmd /c \"START /B powershell.exe -file %AZ_BATCH_APP_PACKAGE_REBOOTNODE%\\RebootCurrentNode.ps1\"","environmentSettings":[{"name":"AZ_BATCH_REGION","value":"' + $batch_region + '"},{"name":"AZ_BATCH_KEY","value":"' + $batch_key+ '"}]}' 
